...
// Тип для формы создания новости
...
export const AddNewsPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setStatusMessage({
                type: 'error',
                text: error instanceof Error ? error.message : 'Ошибка при создании новости'
            });
        } finally {
        ...
        <AdminLayout>
            <div className="pb-8">
                <div className="flex items-center justify-between mb-6">
                    <h1 className="text-2xl font-semibold text-gray-800">Добавление новости</h1>
                    <button
                        type="button"
